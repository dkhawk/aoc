package com.sphericalchickens.aoc2022.day09
...
class Day(private val scope: CoroutineScope) {
  ...
  var bottomLeft = ( Vector(-11 - 1,-15 - 1 ))
  var topRight = ( Vector(14 + 1,5 + 1))
  ...
  val visibleRope: MutableList<Vector> = mutableStateListOf()
  var visitedSquares = (emptySet<Vector>())
  var nextGoal = (Vector(0, 0))
